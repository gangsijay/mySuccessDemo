...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tBtnDefault = '<button type="{type}" tabindex="500" title="{title}" class="{css}  btn-sm" ' +
                '{status}>{icon} {label}</button>';
            //noinspection HtmlUnknownAttribute
            tBtnLink = '<a href="{href}" tabindex="500" title="{title}" class="{css}  btn-sm" {status}>{icon} {label}</a>';
            //noinspection HtmlUnknownAttribute
