        ...
        <div class="main-content-inner">
            <div class="page-content">
                <div class="page-header row">
                    <div class=" col-xs-6">
                        <h1>${role.name}<@spring.message "tr.urlMgr" /></h1>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" role="form" name="roleUrlsForm" id="roleUrlsForm" action="/admin/role/url/add" method="post">
